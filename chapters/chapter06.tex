...
พีชคณิตบูลีน (Boolean Algebra) ศึกษาค่าตรรกะสองค่า คือ 0 และ 1 รวมทั้งการดำเนินการกับค่าเหล่านี้ พีชคณิตบูลีนเป็นพื้นฐานของวงจรดิจิทัล เงื่อนไขในโปรแกรม และการสืบค้นข้อมูล~\parencite{mano2018digital}
...
การดำเนินการทางบูลีนเป็นหัวใจของพีชคณิตบูลีน การดำเนินการทั้งสามได้แก่ OR, AND และ NOT สามารถนิยามได้ทั้งในเชิงคณิตศาสตร์และในเชิงวงจรดิจิทัล ในเชิงคณิตศาสตร์ OR และ AND เป็น binary operations ที่รับค่าสองค่าบูลีนและให้ผลลัพธ์เป็นค่าบูลีน ส่วน NOT เป็น unary operation ที่รับค่าบูลีนหนึ่งค่าและให้ผลลัพธ์ตรงข้าม ในเชิงวงจรดิจิทัล การดำเนินการเหล่านี้ถูกแทนด้วย logic gates ได้แก่ OR gate, AND gate และ NOT gate (inverter) ตามลำดับ การดำเนินการทั้งสามนี้เป็นรากฐานของการออกแบบและวิเคราะห์วงจรดิจิทัล~\parencite{mano2018digital}
...
การดำเนินการ XOR หรือ Exclusive OR เป็นการดำเนินการที่สำคัญมากในวงจรดิจิทัลและการเข้ารหัส ต่างจาก OR ตรงที่ XOR ให้ผลลัพธ์เป็น 1 ก็ต่อเมื่อค่าอินพุตสองค่าแตกต่างกัน (หนึ่งเป็น 0 และอีกหนึ่งเป็น 1) สมบัตินี้ทำให้ XOR เหมาะสำหรับการคำนวณ parity bit ในระบบตรวจจับข้อผิดพลาด และการเข้ารหัสแบบ symmetric encryption~\parencite{kolman2008discrete}
...
กฎการแจกแจงเป็นจุดที่พีชคณิตบูลีนต่างจากพีชคณิตของจำนวนจริงอย่างชัดเจน ในจำนวนจริงการคูณแจกแจงเหนือการบวกได้เพียงทิศทางเดียว แต่ในพีชคณิตบูลีนการแจกแจงเป็นจริงทั้งสองทิศทาง คือ AND แจกแจงเหนือ OR และ OR แจกแจงเหนือ AND กฎคู่นี้เป็นเครื่องมือหลักในการกระจายและจัดกลุ่มพจน์เพื่อลดรูปนิพจน์~\parencite{gersting2014structures}
...
กฎการดูดกลืน (Absorption) อธิบายว่านิพจน์ที่มีตัวแปรเดิมร่วมกับพจน์ที่มีตัวแปรนั้นเป็นตัวประกอบ สามารถลดกลับเป็นตัวแปรเดิมได้ เช่น $a+a b=a$ และ $a(a+b)=a$ กฎนี้ใช้ตัดพจน์ซ้ำซ้อนออกจากนิพจน์บูลีน~\parencite{rosen2019discrete}
...
เมื่อนำตัวแปรบูลีนและการดำเนินการมาประกอบกัน จะได้ฟังก์ชันที่รับข้อมูลเข้าเป็นค่าบูลีนและให้ผลลัพธ์เป็นค่าบูลีน ฟังก์ชันบูลีนที่มีตัวแปร $n$ ตัวถูกกำหนดค่าได้ครบถ้วนด้วยตารางค่าความจริงขนาด $2^n$ แถว ซึ่งหมายความว่าฟังก์ชันบูลีนของตัวแปรจำนวนจำกัดมีได้เพียงจำนวนจำกัดเช่นกัน สมบัตินี้ทำให้ตรวจสอบความถูกต้องของวงจรได้โดยไล่ทุกกรณีของข้อมูลเข้า~\parencite{mano2018digital}
...
นิพจน์บูลีนสองนิพจน์ที่ให้ตารางค่าความจริงเหมือนกันถือว่าสมมูลกัน แต่เมื่อสร้างเป็นวงจรจริงกลับใช้จำนวนเกตไม่เท่ากัน การลดรูปนิพจน์จึงหมายถึงการหานิพจน์ที่สมมูลกับนิพจน์เดิมแต่ใช้จำนวนพจน์และจำนวนตัวแปรน้อยที่สุด ผลที่ได้คือวงจรที่ใช้เกตน้อยลง กินไฟน้อยลง และมีเวลาหน่วงสัญญาณสั้นลง หัวข้อนี้แสดงการลดรูปสองวิธี คือการใช้กฎพีชคณิตบูลีน และการใช้ทฤษฎีบทคอนเซนซัส~\parencite{mano2018digital}

\subsection{การลดรูปด้วยกฎพีชคณิตบูลีน}
การลดรูปใช้กฎพีชคณิตบูลีนเพื่อสร้างนิพจน์ที่สมมูลกับนิพจน์เดิม แต่มีจำนวนพจน์หรือตัวแปรน้อยลง วิธีที่ใช้บ่อยคือจัดกลุ่มพจน์และใช้กฎการแจกแจงหรือกฎคอมพลีเมนต์ นิพจน์ที่สั้นลงอาจลดจำนวนเกตหรือระดับของสัญญาณในวงจรได้~\parencite{mano2018digital}
...
แผนที่ขนาด 2 ตัวแปรมี 4 ช่อง ตรงกับ 4 แถวของตารางค่าความจริงพอดี การเรียงลำดับหัวแถวและหัวคอลัมน์ใช้รหัสเกรย์ (Gray Code) คือเปลี่ยนค่าทีละหนึ่งบิตเมื่อเลื่อนไปช่องข้างเคียง การเรียงแบบนี้ทำให้ช่องที่ติดกันต่างกันเพียงตัวแปรเดียว จึงจับกลุ่มรวมกันแล้วตัดตัวแปรนั้นออกได้ทันที~\parencite{roth2021logic}
...
แผนที่ขนาด 3 ตัวแปรมี 8 ช่อง จัดเป็นตาราง 2 แถว 4 คอลัมน์ การเรียงลำดับหัวแถวและหัวคอลัมน์ใช้รหัสเกรย์ (Gray Code) คือเปลี่ยนค่าทีละหนึ่งบิตเมื่อเลื่อนไปช่องข้างเคียง การเรียงแบบนี้ทำให้ช่องที่ติดกันต่างกันเพียงตัวแปรเดียว จึงจับกลุ่มรวมกันแล้วตัดตัวแปรนั้นออกได้ทันที~\parencite{wakerly2018digital}
...
แผนที่ขนาด 4 ตัวแปรมี 16 ช่อง จัดเป็นตาราง 4 แถว 4 คอลัมน์ การเรียงลำดับหัวแถวและหัวคอลัมน์ใช้รหัสเกรย์ (Gray Code) คือเปลี่ยนค่าทีละหนึ่งบิตเมื่อเลื่อนไปช่องข้างเคียง การเรียงแบบนี้ทำให้ช่องที่ติดกันต่างกันเพียงตัวแปรเดียว จึงจับกลุ่มรวมกันแล้วตัดตัวแปรนั้นออกได้ทันที~\parencite{kolman2008discrete}
...
\label{sec:two-level}
การสร้างวงจรสองระดับจัดวางเกตหลักสองชั้นก่อนถึงขาออก โดยไม่นับอินเวอร์เตอร์ที่ใช้สร้างตัวแปรปฏิเสธ นิพจน์ในรูปผลบวกของผลคูณและผลคูณของผลบวกแปลงเป็นวงจรสองระดับได้โดยตรง เวลาหน่วงจริงยังขึ้นอยู่กับอินเวอร์เตอร์ จำนวนอินพุตของเกต และเทคโนโลยีวงจร~\parencite{wakerly2018digital}
...
วงจรบวกครึ่งและวงจรบวกเต็มใน~\autoref{sec:adders} นำมาต่อเรียงกันเพื่อบวกเลขฐานสองหลายบิต โดยส่งบิตทดจากหลักหนึ่งไปเป็นข้อมูลเข้าของหลักถัดไป โครงสร้างนี้เป็นแกนของหน่วยคำนวณและตรรกะในหน่วยประมวลผลกลาง~\parencite{wakerly2018digital} ตัวอย่างต่อไปนี้แสดงการสร้างวงจรบวกเต็มจากวงจรบวกครึ่งสองชุด
...
ความเชื่อมโยงระหว่างพีชคณิตบูลีน ตรรกศาสตร์ และทฤษฎีเซตเป็นสิ่งสำคัญที่แสดงให้เห็นว่าโครงสร้างทางคณิตศาสตร์ต่างๆ มีความสัมพันธ์กัน~\parencite{rosen2019discrete}
