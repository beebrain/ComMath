...
\begin{solsteps}
  \item วางตัวตั้งและตัวลบให้เรียงตามหลัก:
        \begin{align*}
          ...
          &- \ \ 0001
        \end{align*}
  \item หลักขวาสุด: $0 - 1$ ต้องยืมจากหลักซ้าย แต่หลักที่สองและสามเป็น 0 จึงต้องยืมต่อเนื่องจากหลักที่สี่
  \item หลังยืมต่อเนื่องจาก $1000_2$ หลักที่สี่ลดจาก $1$ เป็น $0$ และหลักที่สามกับหลักที่สองส่ง borrow ต่อไปยังหลักขวาสุด
  \item เขียนภาพรวมของค่าประจำหลักหลังการยืมได้เป็น $0,1,1,10_2$ จากซ้ายไปขวา กล่าวคือหลักซ้ายสามหลักกลายเป็น $0,1,1$ ตามลำดับ และหลักขวาสุดได้รับค่า $10_2$
  \item หลักขวาสุด: $10_2 - 1_2 = 1$
  \item หลักที่สอง: $1 - 0 = 1$
  \item หลักที่สาม: $1 - 0 = 1$
...
\begin{solution}
\begin{solsteps}
  \item แปลง $45$ เป็นฐานสอง 7 bits สำหรับส่วน magnitude: $45 = 0101101_2$
  \item เติม sign bit $0$ ข้างหน้าสำหรับ $+45$: $+45 = 0\,0101101_2 = 00101101_2$
  \item เติม sign bit $1$ ข้างหน้าสำหรับ $-45$: $-45 = 1\,0101101_2 = 10101101_2$
\end{solsteps}
\end{solution}
...
\begin{solution}
\begin{solsteps}
  \item แปลงเป็นฐานสอง: $3.14 \approx 11.00100011..._2$ โดยเป็นค่าประมาณ เพราะ $3.14$ ไม่สามารถแทนได้พอดีด้วยเศษส่วนฐานสองจำนวนจำกัด
...
\end{solsteps}
ดังนั้น $-0.5$ ใน IEEE 754 single precision คือ $10111111000000000000000000000000_2$ หรือ $BF000000_{16}$ (เขียนแบบโปรแกรมได้เป็น \texttt{0xBF000000})
\end{solution}
