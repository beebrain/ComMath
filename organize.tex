...
\indent
ใช้ความรู้พื้นฐานเกี่ยวกับตรรกศาสตร์ เซต ความสัมพันธ์และฟังก์ชัน ระบบเลขฐานต่าง ๆ โดยเฉพาะเลขฐาน 2, 8 และ 16 เมทริกซ์และดีเทอร์มิแนนต์ และพีชคณิตบูลีน
...
\textbf{บทที่ 6 พีชคณิตบูลีน (Boolean Algebra)} ใช้แนวคิดจากตรรกศาสตร์ ทฤษฎีเซต และเลขฐานสอง เพื่อศึกษาฟังก์ชันบูลีน การลดรูปนิพจน์ และการออกแบบวงจรดิจิทัล การดำเนินการ AND, OR และ NOT สอดคล้องกับการเชื่อม การรวมหรือ และการคอมพลีเมนต์ในทฤษฎีเซตตามลำดับ
...
\begin{longtable}{|c|>{\raggedright\arraybackslash}p{4.3cm}|c|>{\raggedright\arraybackslash}p{4.3cm}|c|}
...
\textbf{ตำรา เอกสาร และงานวิจัยประกอบการเรียนการสอน}
...
\vspace{3em}
\begin{flushright}
ลงชื่อ \dotfill อาจารย์ผู้สอน\\[2.8em]
