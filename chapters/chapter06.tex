...
เมื่อกำหนดเอกภพ $U$ และเซตย่อย $A,B \subseteq U$ จะได้ว่า OR สอดคล้องกับยูเนียน $A\cup B$, AND สอดคล้องกับอินเตอร์เซกชัน $A\cap B$ และ NOT สอดคล้องกับส่วนเติมเต็ม $A^c=U-A$ ความสัมพันธ์นี้ทำให้ใช้แนวคิดเดียวกันในการอธิบายตรรกศาสตร์ ทฤษฎีเซต และวงจรดิจิทัล
...
กฎเดอมอร์แกนตั้งชื่อตาม Augustus De Morgan (1806--1871) นักคณิตศาสตร์ชาวอังกฤษ เช่นเดียวกับในทฤษฎีเซต กฎเดอมอร์แกนเป็นหนึ่งในกฎที่สำคัญที่สุดของพีชคณิตบูลีน เนื่องจากเป็นเครื่องมือในการหา complement ของนิพจน์บูลีนที่ซับซ้อน หลักการพื้นฐานของกฎเดอมอร์แกนคือ complement ของผลลัพธ์จะเท่ากับผลลัพธ์ของ complements แต่ต้องสลับเครื่องหมายการดำเนินการด้วย~\cite{mano2018digital}
...
\begin{enumerate}
    ...
    \item หาตัวแปรที่ไม่เปลี่ยนแปลงในกลุ่ม (คงที่) ตัวแปรที่เป็น 1 ใช้ตัวแปรเดี่ยว ส่วนตัวแปรที่เป็น 0 ใช้ complement
...
\begin{principle}[NAND Gate และความสมบูรณ์เชิงฟังก์ชัน (Universal Gate)]
...
\begin{principle}[NOR Gate และความสมบูรณ์เชิงฟังก์ชัน (Universal Gate)]
...
จากหัวข้อความสมบูรณ์เชิงฟังก์ชันใน~\autoref{sec:boolean-applications} NAND สามารถสร้าง NOT, AND และ OR ได้ ตัวอย่างนี้แสดงการสร้าง AND จาก NAND สองตัว
...
\begin{exercise}
ใช้กฎเดอมอร์แกนเพื่อเขียน complement ของ ดังนี้
\begin{enumerate}
    \item $x y + x' z$
    \item $(x + y + z)(x' y' z')'$
    \item $(a + b)(c + d)$
