...
- **งานค้างที่พบระหว่างทาง รอรอบของบทนั้น**
  1. ~~ch4 อ้างหัวข้อจำนวนติดลบที่ไม่มีอยู่จริง~~ **ปิดแล้ว** ผู้เขียนตัดสินให้ตัดออก
     ดูหัวข้อ "คำตัดสินเรื่องคอมพลีเมนต์สองใน ch4" ด้านล่าง
...
## คำตัดสินเรื่องคอมพลีเมนต์สองใน ch4 (2026-08-10)

**ไม่ใส่เนื้อหาคอมพลีเมนต์สองและจำนวนเต็มมีเครื่องหมายใน ch4 และตัดทุกประโยคที่โยงถึงออกแล้ว**

หลักฐานที่ใช้ตัดสิน ตรวจครบสามระดับแล้วไม่พบคำว่า complement เลย
- `CourseSynllabus_Math_for_Com.pdf` คำอธิบายรายวิชาเขียนว่า "ระบบเลขฐานต่าง ๆ โดยเฉพาะเลขฐาน 2, 8, 16" · จุดประสงค์การเรียนรู้ 5 ข้อ · ตารางสอนสัปดาห์ 9-11
- `chapters/chapter04_or.tex` วัตถุประสงค์ประจำบท 5 ข้อ และหัวข้อที่สอน 6 ข้อ
- ไฟล์ `_or.tex` ทั้ง 6 บท เจอคำว่าคอมพลีเมนต์ที่เดียวคือ ch2 ซึ่งเป็นคอมพลีเมนต์ของ**เซต** คนละเรื่องกัน

สิ่งที่ทำ
- ch4 บรรทัดที่เคยอ้าง "จะศึกษาในหัวข้อจำนวนติดลบ" ตัดออกทั้งสองจุด จุดหนึ่งเปลี่ยนไปชี้ `\autoref{ch:boolean}` แทน เพราะ `chapter06_or.tex` ระบุ "วงจรเชิงผสม วงจรบวก และวงจรสองระดับ" ไว้ในหัวข้อที่สอนจริง
- ลบ `Figures/png_ready/28-2s-complement-manual.png` ออกจาก repo (อยู่ในประวัติ git กู้คืนได้)
- คงคำว่า "จำนวนเต็มไม่ติดลบ" ในหัวข้อการหารไว้ เพราะเป็นการจำกัดขอบเขตที่ถูกต้อง ถ้าตัดจะทำให้ข้อความผิด

**ห้ามเปิดประเด็นนี้ใหม่** เว้นแต่คำอธิบายรายวิชาถูกแก้ให้มีคอมพลีเมนต์สอง
