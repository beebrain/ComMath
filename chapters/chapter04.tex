...
\end{rem}
\label{rem:floating-point-error}
...
\begin{enumerate}
    ...
    \item $1 + 0 + \text{ทด}1 = 10$ คือ เขียน 0 ทด 1
    \item $0 + 1 + \text{ทด}1 = 10$ คือ เขียน 0 ทด 1
    \item $1 + 1 + \text{ทด}1 = 11$ คือ เขียน 1 ทด 1
...
ขั้นตอนการยืม (borrowing) มีดังนี้:
\begin{enumerate}
    \item หลักขวาสุด: $0 - 1$ ต้องยืม 1 จากหลักซ้าย แต่หลักซ้ายเป็น 0 จึงต้องยืมต่อไปยังหลักถัดไป
    \item หลักที่สอง: $0$ ยืมจากหลักที่สาม หลักที่สามกลายเป็น $9$ (ในฐานสองคือ borrow 1 = ลด 1 จากหลักซ้าย)
