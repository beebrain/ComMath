...
\end{ex}
\begin{solution}
วงจรดิจิทัล $0 =$ แรงดันระดับต่ำ, $1 =$ แรงดันระดับสูง; ตรรกศาสตร์ $0 =$ เท็จ, $1 =$ จริง; ทฤษฎีเซต $0$ สอดคล้องกับเซตว่างและ $1$ สอดคล้องกับเอกภพ ระดับแรงดันจริงขึ้นอยู่กับเทคโนโลยีของวงจร
...
การดำเนินการทางบูลีนเป็นหัวใจของพีชคณิตบูลีน แม้ว่าชื่อและตารางค่าความจริงของการดำเนินการ OR, AND, NOT, XOR จะมีความคล้ายคลึงกับตัวเชื่อมทางตรรกศาสตร์ ($\lor, \land, \neg, \oplus$) ใน\autoref{ch:logic} แต่มีข้อแตกต่างสำคัญในเชิงกรอบความคิด กล่าวคือ ในตรรกศาสตร์ประพจน์เรามุ่งเน้นการประเมินค่าความจริงของข้อความเพื่อการให้เหตุผล แต่ในพีชคณิตบูลีน เรามองตัวดำเนินการเหล่านี้เป็นการดำเนินการเชิงคำนวณบนเซตตัวเลข $\{0, 1\}$ ซึ่งเรียกว่า พีชคณิตสวิตช์ชิง (Switching Algebra) โดยสัญลักษณ์ $+$ สอดคล้องกับการต่อสวิตช์ไฟฟ้าแบบขนาน (Parallel Switch), สัญลักษณ์ $\cdot$ สอดคล้องกับการต่อสวิตช์ไฟฟ้าแบบอนุกรม (Series Switch) และสัญลักษณ์ $'$ สอดคล้องกับอินเวอร์เตอร์ (Inverter) ที่กลับระดับแรงดันไฟฟ้า การกำหนดสัญลักษณ์เช่นนี้ทำให้สามารถใช้กฎทางพีชคณิตมาช่วยจัดรูปและลดขนาดของวงจรดิจิทัลได้อย่างเป็นระบบ~\parencite{mano2018digital}

ในการศึกษาพีชคณิตบูลีน เราจะใช้ ตารางค่าความจริง เป็นเครื่องมือสำคัญในการแสดงผลลัพธ์ของการดำเนินการสำหรับทุกกรณีของค่าอินพุต สำหรับตัวแปร $n$ ตัวจะมี $2^n$ แถวใน ตารางค่าความจริง ดังนั้นสำหรับ 2 ตัวแปรจะมี 4 แถว และสำหรับ 3 ตัวแปรจะมี 8 แถว ความสามารถในการอ่านและเขียน ตารางค่าความจริง อย่างคล่องแคล่วจึงเป็นทักษะพื้นฐานที่จำเป็นสำหรับทุกผู้ศึกษาเกี่ยวกับวงจรดิจิทัล
...
\end{ex}
\begin{solution}
สร้าง ตารางค่าความจริง เปรียบเทียบทั้งสองข้าง
\begin{center}
...
กฎของพีชคณิตบูลีน (Boolean identities) เป็นความสัมพันธ์ที่เป็นจริงสำหรับทุกค่าของตัวแปรบูลีน กฎเหล่านี้สามารถพิสูจน์ได้โดยการตรวจสอบทุกกรณีของค่าตัวแปรผ่าน ตารางค่าความจริง หรือโดยการใช้กฎอื่นที่ได้พิสูจน์แล้ว กฎเหล่านี้มีความสำคัญอย่างยิ่งในการลดรูปนิพจน์บูลีน ซึ่งเป็นพื้นฐานของการออกแบบวงจรดิจิทัลที่มีประสิทธิภาพ การลดรูปนิพจน์บูลีนที่ซับซ้อนให้เป็นรูปแบบที่ง่ายกว่าจะช่วยลดจำนวน logic gates ที่ต้องใช้ ทำให้วงจรมีขนาดเล็กลง ประหยัดพลังงานมากขึ้น และทำงานได้เร็วขึ้น~\parencite{mano2018digital}
...
\begin{proof}
พิสูจน์โดยใช้ ตารางค่าความจริง พิจารณาทุกกรณีของ $a$ และ $b$:
...
นิพจน์บูลีนสร้างจากตัวแปรบูลีน ค่าคงตัว 0 และ 1 และการดำเนินการ OR, AND และ NOT โดยใช้วงเล็บเพื่อกำหนดลำดับการดำเนินการ ฟังก์ชันบูลีนสามารถนำเสนอได้หลายรูปแบบ ได้แก่ ตารางค่าความจริง, นิพจน์บูลีน, และแผนที่คาร์นอ (Karnaugh map)
...
ฟังก์ชันบูลีนสามารถแทนด้วยตารางค่าความจริง (ตารางค่าความจริง) ที่แสดงผลลัพธ์สำหรับทุกชุดค่าอินพุตที่เป็นไปได้
...
\end{ex}
\begin{solution}
สร้าง ตารางค่าความจริง ของฟังก์ชัน
\begin{center}
...
หลังจากเข้าใจ Minterm แล้ว ตอนนี้เราสามารถนำ Minterms มาประกอบกันเป็นรูปแบบ Sum of Products (SOP) ซึ่งเป็นรูปแบบมาตรฐานที่สำคัญในการออกแบบวงจรดิจิทัล SOP คือการนำผลคูณ (AND) ของตัวแปรหลาย ๆ พจน์มาบวก (OR) กัน รูปแบบนี้เรียกอีกอย่างว่า ``ผลบวกของผลคูณ'' เพราะเราเอาผลคูณหลาย ๆ อันมาบวกกัน การเขียนฟังก์ชันในรูปแบบ SOP ทำให้ง่ายต่อการแปลงเป็นวงจรที่ใช้ AND gate และ OR gate~\parencite{kolman2008discrete}
...
จาก ตารางค่าความจริง ของ $f(x, y, z)$ ที่ $f = 1$ สำหรับ minterms $m_1, m_3, m_5, m_7$:
\end{ex}
\begin{solution}
\begin{align*}
...
นอกจาก SOP แล้ว ยังมีอีกรูปแบบหนึ่งที่สำคัญคือ Product of Sums (POS) หรือ ``ผลคูณของผลบวก'' ซึ่งเป็นรูปแบบที่ใช้ Maxterms มาประกอบกัน รูปแบบ POS คือการนำผลบวก (OR) ของตัวแปรหลาย ๆ พจน์มาคูณ (AND) กัน รูปแบบนี้มีประโยชน์ในบางสถานการณ์ เช่น เมื่อต้องการวงจรที่ใช้ NOR gate เป็นหลัก หรือเมื่อฟังก์ชันถูกกำหนดในรูปแบบที่ง่ายต่อการเขียนเป็น POS การเข้าใจทั้ง SOP และ POS ทำให้สามารถเลือกใช้รูปแบบที่เหมาะสมกับการออกแบบวงจรได้~\parencite{gersting2014structures}
...
จากสมบัติของเกตสากล (Universal Gate) ใน~\autoref{sec:boolean-applications} ซึ่งระบุว่า NAND Gate สามารถนำมาต่อเชื่อมเพื่อสร้างการทำงานของ NOT, AND และ OR ได้อย่างสมบูรณ์ ตัวอย่างนี้แสดงขั้นตอนการสังเคราะห์ AND Gate โดยใช้ NAND Gate เพียง 2 ตัว เพื่อลดความซับซ้อนและประหยัดต้นทุนในสายการผลิตชิปวงจรรวม (IC)~\parencite{mano2018digital}
...
$\therefore$ ประตู NAND สร้างประตูพื้นฐานได้ทุกชนิด จึงเรียกว่าประตูสากล \solhere
\end{solution}
...
\begin{exercise}
เขียน ตารางค่าความจริง สำหรับ ดังนี้
\begin{enumerate}
    \item $f(x, y) = x + y'$
    \item $f(x, y) = (x + y)'$
...
\begin{enumerate}
    ...
    \item ลงแผนที่คาร์นอ 3 ตัวแปร โดยแถว $x=0$ มีค่าที่ $yz=00(d), 01(1), 11(1), 10(0)$ และแถว $x=1$ มีค่าที่ $yz=00(0), 01(d), 11(1), 10(0)$ · จัดกลุ่มได้ดังนี้ (1) รวม $m_1, m_3, m_7$ กับ $d(5)$ เป็นกลุ่มขนาด 4 (คอลัมน์ $yz=01, 11$) ได้พจน์ $z$ โดยเลือก $d(5)=1$ (2) รวม $m_1$ กับ $d(0)$ เป็นกลุ่มขนาด 2 (แถว $x=0$, คอลัมน์ $yz=00, 01$) ได้พจน์ $x'y'$ โดยเลือก $d(0)=1$ $\therefore f(x,y,z) = z + x'y'$ ซึ่งการกำหนด Don't Care ทั้งสองเป็น 1 ทำให้ขยายกลุ่มได้ใหญ่ที่สุดและลดรูปได้สูงสุด
...
\begin{enumerate}
    ...
    \Pointilles{3}
    \item จงเขียน ตารางค่าความจริง สำหรับการดำเนินการ AND, OR, NOT และ XOR
    \Pointilles{3}
    \item จงพิสูจน์ $(a + b)' = a' \cdot b'$ โดยใช้ ตารางค่าความจริง
    \Pointilles{3}
