...
%% รูปประกอบทุกรูปเป็นไฟล์ PNG ใน Figures/png_ready เล่มนี้เลิกใช้ TikZ แล้ว
%% สีที่ตารางในเนื้อหาใช้ (navy, lred) ย้ายไปนิยามใน mathstyle.sty
...
\newtheorem{warning}{ข้อควรระวัง}[chapter]
...
%% ชื่อที่ \autoref เติมให้กล่องแต่ละชนิด ถ้าไม่นิยามไว้ hyperref จะพิมพ์เลขเปล่า
%% ติดกับข้อความไทยโดยไม่มีวรรค เช่น "ใน2.2" ซึ่งชี้ได้หลายตำแหน่งในบทเดียวกัน
\def\thrmautorefname{ทฤษฎีบท}
\def\exautorefname{ตัวอย่างที่}
\def\remautorefname{หมายเหตุ}
\def\warningautorefname{ข้อควรระวัง}
\def\propautorefname{บทแทรก}
\def\corautorefname{บทสรุป}
\def\lawautorefname{กฎ}
\def\principleautorefname{หลักการ}
\def\exerciseautorefname{แบบฝึกหัด}
