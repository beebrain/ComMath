...
\titleformat{\section}{\large\bfseries\upshape}{\thesection}{1em}{}
\titleformat{\subsection}{\bfseries\upshape}{\thesubsection}{1em}{}
...
\begin{document}
	...
	%% บทที่ 7 (ยังไม่เปิดใช้งาน)
	%\cleartoleftpage
	%\include{chapters/chapter07_or}
	%\cleartoleftpage
