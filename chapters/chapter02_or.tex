...
\begin{enumerate}[topsep=0.3em, itemsep=0.25em]
    ...
    \item การดำเนินการระหว่างเซตและแผนภาพเวนน์ (Set Operations and Venn Diagrams)
    \item กฎของเดมอร์แกน (De Morgan's Laws)
    \item การนับจำนวนสมาชิกของเซต (Cardinality)
    \item เซตที่นับได้และเซตที่นับไม่ได้ (Countable and Uncountable Sets)
