...
\begin{frame}{ทบทวนสัปดาห์ที่ 5 : การดำเนินการและกฎพีชคณิตของเซต}
  ...
  \begin{exampleblock}{สัปดาห์นี้ = สัปดาห์ปิดบทที่ 2 (แก่นแท้ของการสร้างและนับเซต)}
    \begin{itemize}\small
      ...
      \item \textbf{จำนวนสมาชิก (Cardinality)} : หลักการรวม-การแยกแบบเจาะลึก $|A \cup B|$ และ $|A \cup B \cup C|$
...
\begin{frame}{วัตถุประสงค์การเรียนรู้ (สัปดาห์ที่ 6)}
  ...
  \begin{enumerate}
    ...
    \item เข้าใจกระบวนการคำนวณ \textbf{จำนวนสมาชิกของเซต (Cardinality)} หาค่า \textbf{$|A \cup B|$} และ \textbf{$|A \cup B \cup C|$} ทั้งด้วยสูตรและแผนภาพเวนน์เป็นขั้นตอน พร้อมตรวจความสอดคล้องของข้อมูลได้
...
\begin{frame}{การหา $|A \cup B \cup C|$ (หลักการรวม-การแยกสำหรับ 3 เซต)}
  ...
  \end{center}
  \vspace{0.1em}
  \footnotesize หากไม่บวก $|A \cap B \cap C|$ กลับเข้าไปในขั้นตอนสุดท้าย ส่วนซ้อน 3 เซตจะถูกหักออกจนเหลือ $0$ ($+3 - 3 = 0$)
\end{frame}
