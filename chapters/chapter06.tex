...
\begin{align*}
f &= (a + b) \cdot (a' + c) + (b + c) \\
  &= \underbrace{(a + b) \cdot a'}_{พจน์ที่ 1} + \underbrace{(a + b) \cdot c}_{พจน์ที่ 2} + (b + c) \quad \text{(Distributive: } x \cdot (y + z) = x \cdot y + x \cdot z \text{)} \\
  &= \underbrace{a \cdot a'}_{พจน์ที่ 1} + \underbrace{b \cdot a'}_{พจน์ที่ 2} + \underbrace{a \cdot c}_{พจน์ที่ 3} + \underbrace{b \cdot c}_{พจน์ที่ 4} + b + c \quad \text{(Distributive อีกครั้ง)} \\
  &= 0 + b \cdot a' + a \cdot c + b \cdot c + b + c \quad \text{(Complement: } a \cdot a' = 0 \text{)} \\
  &= b \cdot a' + a \cdot c + \underbrace{b \cdot c + b}_{พจน์ที่ 5} + c \\
