...
การดำเนินการ NOT กลับค่าบูลีนจากค่าหนึ่งไปเป็นอีกค่าหนึ่ง สอดคล้องกับการปฏิเสธ ``ไม่'' ในตรรกศาสตร์ ต่างจาก OR และ AND ตรงที่ NOT รับตัวถูกดำเนินการเพียงตัวเดียว จึงเรียกว่าการดำเนินการเอกภาค (Unary Operation) ในทางวงจรดิจิทัล การดำเนินการนี้สร้างด้วยวงจรอินเวอร์เตอร์ที่ให้แรงดันขาออกตรงข้ามกับขาเข้าเสมอ
...
กฎการแจกแจงเป็นจุดที่พีชคณิตบูลีนต่างจากพีชคณิตของจำนวนจริงอย่างชัดเจน ในจำนวนจริงการคูณแจกแจงเหนือการบวกได้เพียงทิศทางเดียว แต่ในพีชคณิตบูลีนการแจกแจงเป็นจริงทั้งสองทิศทาง คือ AND แจกแจงเหนือ OR และ OR แจกแจงเหนือ AND กฎคู่นี้เป็นเครื่องมือหลักในการกระจายและจัดกลุ่มพจน์เพื่อลดรูปนิพจน์
...
แผนที่ขนาด 2 ตัวแปรมี 4 ช่อง ตรงกับ 4 แถวของตารางค่าความจริงพอดี การเรียงลำดับหัวแถวและหัวคอลัมน์ใช้รหัสเกรย์ (Gray Code) คือเปลี่ยนค่าทีละหนึ่งบิตเมื่อเลื่อนไปช่องข้างเคียง การเรียงแบบนี้ทำให้ช่องที่ติดกันต่างกันเพียงตัวแปรเดียว จึงจับกลุ่มรวมกันแล้วตัดตัวแปรนั้นออกได้ทันที
...
แผนที่ขนาด 3 ตัวแปรมี 8 ช่อง จัดเป็นตาราง 2 แถว 4 คอลัมน์ การเรียงลำดับหัวแถวและหัวคอลัมน์ใช้รหัสเกรย์ (Gray Code) คือเปลี่ยนค่าทีละหนึ่งบิตเมื่อเลื่อนไปช่องข้างเคียง การเรียงแบบนี้ทำให้ช่องที่ติดกันต่างกันเพียงตัวแปรเดียว จึงจับกลุ่มรวมกันแล้วตัดตัวแปรนั้นออกได้ทันที
...
แผนที่ขนาด 4 ตัวแปรมี 16 ช่อง จัดเป็นตาราง 4 แถว 4 คอลัมน์ การเรียงลำดับหัวแถวและหัวคอลัมน์ใช้รหัสเกรย์ (Gray Code) คือเปลี่ยนค่าทีละหนึ่งบิตเมื่อเลื่อนไปช่องข้างเคียง การเรียงแบบนี้ทำให้ช่องที่ติดกันต่างกันเพียงตัวแปรเดียว จึงจับกลุ่มรวมกันแล้วตัดตัวแปรนั้นออกได้ทันที
...
\{m_0, m_1, m_8, m_9\}\ (\text{แถวบน-ล่าง wrap},\ y = 0) &\Rightarrow x'y'
\end{align*}
...
\label{sec:two-level}
การสร้างวงจรสองระดับหมายถึงการจัดวางประตูสัญญาณให้สัญญาณเดินทางผ่านประตูเพียงสองชั้นก่อนถึงขาออก เวลาหน่วงรวมของวงจรจึงเท่ากับเวลาหน่วงของประตูสองตัวเสมอ ไม่ว่านิพจน์จะมีกี่พจน์ รูปแบบนี้จึงให้ความเร็วสูงสุดและใช้กันแพร่หลาย นิพจน์ในรูปผลบวกของผลคูณและผลคูณของผลบวกแปลงเป็นวงจรสองระดับได้โดยตรง
...
\label{sec:adders}
วงจรบวกเป็นตัวอย่างที่ชัดเจนที่สุดของการนำพีชคณิตบูลีนไปสร้างเป็นฮาร์ดแวร์ วงจรบวกครึ่งรับข้อมูลเข้า 2 บิตแล้วให้ผลบวกกับบิตทด ส่วนวงจรบวกเต็มรับเพิ่มอีกหนึ่งบิตคือบิตทดจากหลักก่อนหน้า จึงนำมาต่อกันเป็นชุดเพื่อบวกเลขหลายบิตได้ ทั้งสองวงจรเป็นส่วนประกอบภายในหน่วยคำนวณและตรรกะที่กล่าวถึงในบทที่ 4
...
กฎที่ศึกษามาตลอดบทนี้มีจำนวนมากจนจดจำได้ยาก การรวบรวมไว้ในที่เดียวช่วยให้เปรียบเทียบและเลือกใช้ได้สะดวกขณะลดรูปนิพจน์ ตารางต่อไปนี้สรุปกฎทั้งหมดพร้อมชื่อเรียกมาตรฐาน โดยจัดคู่กฎที่เป็นคู่ทวิภาค (Dual) ไว้ในแถวเดียวกัน ซึ่งได้จากการสลับ AND กับ OR และสลับ 0 กับ 1 พร้อมกัน
